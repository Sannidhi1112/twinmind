...
import com.voicerecorder.ui.viewmodel.SummaryViewModel
...
fun SummaryScreen(
    ...
    Scaffold(
        ...
        when (val state = uiState) {
            ...
            is SummaryViewModel.SummaryUiState.Streaming -> {
                StreamingContent(
                    modifier = Modifier
                        .fillMaxSize()
                        .padding(paddingValues),
...
@Composable
fun StreamingContent(modifier: Modifier = Modifier, partialSummary: String) {
    Column(
        modifier = modifier
